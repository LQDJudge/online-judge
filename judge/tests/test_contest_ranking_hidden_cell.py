...
viewer can open the popup like any other cell -- the popup itself masks the result
(UserContestSubmissionsAjax returns submissions=None when hidden), so nothing leaks.
"""
