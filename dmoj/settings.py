...
BRIDGED_DJANGO_TIMEOUT_SECONDS = 10
...
DEFAULT_TESTCASE_PREVIEW_MAX_BYTES = 512
TESTCASE_PREVIEW_MAX_BYTES = DEFAULT_TESTCASE_PREVIEW_MAX_BYTES
# Deprecated: use TESTCASE_PREVIEW_MAX_BYTES.
TESTCASE_VISIBLE_LENGTH = TESTCASE_PREVIEW_MAX_BYTES
